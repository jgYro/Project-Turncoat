...
const Usage = """Local graph explorer
Usage: graphapp [--db:PATH] COMMAND [arguments]
  init                         Initialize SQLite
  serve                        Start the local graph explorer (default command)
...
Environment overrides: GRAPHAPP_DB, GRAPHAPP_HOST, GRAPHAPP_PORT
"""
